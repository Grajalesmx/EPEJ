...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(payment_id) FROM payments";
...
// Define the query:
$q = "SELECT payment_id, first_name, last_name, community, payment, ticket, file , DATE_FORMAT(registration_date, '%M %d, %Y') AS dr FROM payments_v ORDER BY $order_by LIMIT $start, $display";		
...
<tr>
	...
	<td align="left"><b><a href="payments_view.php?sort=pay">No. de Pago</a></b></td>
	<td align="left"><b><a href="payments_view.php?sort=tic">No. de Recibo</a></b></td>
	<td align="left"><b><a href="payments_view.php?sort=rd">Date Registered</a></b></td>
</tr>
';
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
	$bg = ($bg=='#eeeeee' ? '#ffffff' : '#eeeeee');
		...
		<td align="left"> <a target="new" href="tickets/'. $row['file'] .'">'. $row['ticket'] . '</a> </td>
